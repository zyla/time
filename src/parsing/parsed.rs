...
use crate::date_time::{maybe_offset, DateTime, MaybeOffset};
...
impl TryFrom<Parsed> for PrimitiveDateTime {
    type Error = <DateTime<maybe_offset::None> as TryFrom<Parsed>>::Error;
...
impl TryFrom<Parsed> for OffsetDateTime {
    type Error = <DateTime<maybe_offset::Fixed> as TryFrom<Parsed>>::Error;
